...
final productFormProvider = NotifierProvider.autoDispose.family<ProductFormNotifier,ProductFormState, Product>((product){
  return ProductFormNotifier(product: product );
});

class ProductFormNotifier extends Notifier<ProductFormState>{

  late final Future<bool> Function(Map<String,dynamic> productLike)? onSubmitCallback;
  ...
  ProductFormState build() {
    ...
    onSubmitCallback = ref.watch(productsProvider.notifier).createOrUpdateProduct;
